...
class ModelFactory:
    ...
    def create_model(
        ...
        **kwargs
        ...
        temperature = temperature if temperature is not None else float(os.getenv("MODEL_TEMPERATURE", 0.0))
    ...
    @staticmethod
    def _create_bedrock_model(temperature: float, max_tokens: Optional[int] = None, **kwargs) -> BedrockModel:
